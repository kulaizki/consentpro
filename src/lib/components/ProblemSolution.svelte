...
>
	<div class="container mx-auto px-4">
		<div class="text-center mb-14 md:mb-20 max-w-3xl mx-auto">
			<h2
				class="text-4xl sm:text-5xl font-bold text-sky-800 leading-tight transition-all duration-700 ease-out {isInView
			...
			<p
				class="text-4xl sm:text-5xl font-bold text-sky-500 leading-tight mt-1 sm:mt-2 transition-all duration-700 ease-out {isInView
					? 'opacity-100 translate-y-0'
					: 'opacity-0 -translate-y-8'}"
			...
			<p
				class="text-lg md:text-xl text-sky-600 mt-4 md:mt-5 transition-all duration-700 ease-out {isInView
					? 'opacity-100 translate-y-0'
					: 'opacity-0 translate-y-8'}"
				style="transition-delay: 400ms;"
			>
				ConsentPro moves beyond confusing regulations, offering a clear path to confident,
		...
		<div class="grid md:grid-cols-2 gap-8 md:gap-10 items-stretch">
			<div
				class="bg-white/80 backdrop-blur-sm p-8 md:p-10 rounded-xl shadow-lg 
			...
			>
				...
				<p class="text-lg text-sky-700 mb-5 flex-grow">
					Navigating NPC Circular No. 2023-04 is complex. Manual consent tracking is
					inefficient, prone to errors, and puts your business at risk of significant fines and
					reputational damage.
				</p>
			...
			>
				...
				<p class="text-lg text-sky-700 mb-5 flex-grow">
					We automate and simplify the entire consent management process, from form creation to
					record-keeping, ensuring you are always compliant and your customer data is handled
					correctly.
				</p>
