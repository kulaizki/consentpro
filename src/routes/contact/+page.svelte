			...
			<form on:submit|preventDefault={handleSubmit} class="space-y-6">
				<div class="flex flex-col gap-y-6">
					<div class="flex flex-col gap-y-2">
						<label for="name" class="block text-sm font-medium text-sky-700">Your Name</label>
						<input type="text" id="name" placeholder="John Doe" class="w-full px-4 py-3 rounded-lg border border-sky-200 bg-white/50 focus:outline-none focus:ring-2 focus:ring-sky-400 transition" required />
					</div>
					<div class="flex flex-col gap-y-2">
						<label for="email" class="block text-sm font-medium text-sky-700">Your Email</label>
						<input type="email" id="email" placeholder="you@company.com" class="w-full px-4 py-3 rounded-lg border border-sky-200 bg-white/50 focus:outline-none focus:ring-2 focus:ring-sky-400 transition" required />
					</div>
					<div class="flex flex-col gap-y-2">
						<label for="message" class="block text-sm font-medium text-sky-700">Message</label>
						<textarea id="message" placeholder="How can we help you?" rows="5" class="w-full px-4 py-3 rounded-lg border border-sky-200 bg-white/50 focus:outline-none focus:ring-2 focus:ring-sky-400 transition" required></textarea>
					</div>
				</div>
