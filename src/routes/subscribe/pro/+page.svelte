<script lang="ts">
	...
	async function handleSubmit() {
		...
		successMessage = 'Payment successful! Welcome to ConsentPro Pro.';
		loading = false;
	}
</script>
	...
	>
		...
		>
			<div class="text-center mb-10">
				...
				<p class="text-sky-600 mt-2">You're subscribing to the <span class="font-semibold text-sky-700">Pro Plan</span>.</p>
			</div>
